...
function loadTechnologies(technos) {
    fetch('https://us-central1-pwa-technos-lanfranchi.cloudfunctions.net/getTechnos')
        .then(response => {
            response.json()
                .then(technos => {
...
if(navigator.serviceWorker) {
    ...
    navigator.serviceWorker
        ...
        .then(registration =>{
            ...
            const publicKey = "BC84Oj2SsNRgMXQrLHOFPJeDqxstG9bS3UScT4OpTU4N3YR_a2kGm3LvzbSqaVL2rDCFWl6O0zhXGjTWA8OXSUg";
